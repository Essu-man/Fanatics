...
export const footballTeams: Team[] = [
    ...
    { id: "porto", name: "Porto", league: "Portuguese Liga", country: "Portugal", logo: "https://logos-world.net/wp-content/uploads/2020/06/Porto-Logo.png" },
    { id: "benfica", name: "Benfica", league: "Portuguese Liga", country: "Portugal", logo: "https://logos-world.net/wp-content/uploads/2020/06/Benfica-Logo.png" },
    { id: "sporting-cp", name: "Sporting CP", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/4/4f/Sporting_Clube_de_Portugal.png" },
    { id: "braga", name: "Braga", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/6/6e/Sporting_Clube_de_Braga.png" },
    { id: "v-guimaraes", name: "V. Guimarães", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/8/8c/Vitoria_SC.png" },
    { id: "famalicao", name: "Famalicão", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/2/2e/F.C._Famalic%C3%A3o.png" },
    { id: "gil-vicente", name: "Gil Vicente", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/2/2c/Gil_Vicente_FC.png" },
    { id: "moreirense", name: "Moreirense", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/7/7a/Moreirense_FC.png" },
    { id: "boavista", name: "Boavista", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/2/2e/Boavista_FC.png" },
    { id: "rio-ave", name: "Rio Ave", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/7/7e/Rio_Ave_FC.png" },
    { id: "estoril", name: "Estoril", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/2/2a/G.D._Estoril_Praia.png" },
    { id: "arouca", name: "Arouca", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/2/2e/F.C._Arouca.png" },
    { id: "santa-clara", name: "Santa Clara", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/2/2d/CD_Santa_Clara.png" },
    { id: "casa-pia", name: "Casa Pia", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/2/2d/Casa_Pia_A.C..png" },
    { id: "farense", name: "Farense", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/2/2d/S.C._Farense.png" },
    { id: "portimonense", name: "Portimonense", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/2/2d/Portimonense_SC.png" },
    { id: "chaves", name: "Chaves", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/2/2d/G.D._Chaves.png" },
    { id: "estrela-amadora", name: "Estrela Amadora", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/2/2d/C.F._Estrela_da_Amadora.png" },
    { id: "vizela", name: "Vizela", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/2/2d/F.C._Vizela.png" },
    { id: "avs-futebol", name: "AVS Futebol SAD", league: "Portuguese Liga", country: "Portugal", logo: "https://upload.wikimedia.org/wikipedia/en/2/2d/AVS_Futebol_SAD_logo.png" },
