// scripts/link-portuguese-liga.js
// Script to update Firestore teams to set league to 'Primeira Liga' for Portuguese teams
...
async function linkPortugueseLiga() {
    for (const name of PORTUGUESE_TEAMS) {
        ...
        for (const doc of snapshot.docs) {
            await doc.ref.update({ league: 'Primeira Liga' });
            console.log(`Linked ${name} to Primeira Liga`);
        }
    }
