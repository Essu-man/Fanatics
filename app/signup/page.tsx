...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-zinc-50 via-white to-zinc-100 flex items-center justify-center p-6">
            <div className={`w-full transition-all duration-500 ${formData.role === 'vendor' ? 'max-w-2xl' : 'max-w-md'}`}>
                        ...
                        <>
                            ...
                            <div className="mt-8 pt-6 border-t border-zinc-200 text-center text-sm">
                                <p className="text-zinc-600">
                                    ...
                                    <Link href="/login" className="font-semibold text-zinc-900 hover:text-emerald-600 hover:underline transition-colors">
                                        Sign in
                                    </Link>
                                </p>
                            </div>
